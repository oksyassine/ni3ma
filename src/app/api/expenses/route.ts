...
import { postExpense } from "@/lib/journal";
...
export async function POST(req: NextRequest) {
  ...
  // Auto-post to the PCAF journal (debit expense account, credit treasury).
  await postExpense(expense.id).catch((err) =>
    console.error("[journal] postExpense failed", err),
  );
